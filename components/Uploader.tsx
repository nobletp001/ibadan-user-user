...
const Uploader: React.FC<UploaderProps> = ({
  ...
  const handleFileChange = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    if (files) {
      ...
      // Update fileNames using the state directly
  ...
  const removeImage = (index: number) => {
    ...
    setFileNames((prevFileNames: string[]) => {
  ...
  return (
    <>
      <div className="my-10">
        <div className="flex items-center flex-col lg:flex-row gap-3 lg:gap-6 ">
          <div className="flex lg:w-1/2 w-full h-[120px] justify-between bg-[#F0F3F8] border-dotted border-grey-900 px-10 items-center border-2">
            <div>
          ...
          <div className={`flex lg:w-1/2 w-full gap-2 ${uploadedImages.length >0 ?"h-[120px]": "h-[0px]"}`}>
