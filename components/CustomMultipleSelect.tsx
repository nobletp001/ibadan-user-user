...
interface CustomSelectProps {
  options: Option[];
  toggle: (val: string, title: string) => void;
  error: string;
  title: string;
}

const CustomMultipleSelect: React.FC<CustomSelectProps> = ({
  options,
  toggle,
  error,
  title,
  ...
  const handleOutsideClick = (event: MouseEvent) => {
    ...
    const dropdown = document.getElementById(`custom-select-${title}`);
  ...
  return (
    <div id={`custom-select-${title}`} className="relative">
      <div
