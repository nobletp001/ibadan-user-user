...
interface RentFirstSlideProps {
  handleNextClick: (inputValues: TFirstPagePayload) => void;
}

const RentFirstSlide: React.FC<RentFirstSlideProps> = ({ handleNextClick }) => {
  const [userBuy, setUserBuy] = useState<TFirstPagePayload>({
    locationId: "",
    otherLocationId: "",
    propertyId: "",
    subPropertyId: "",
  ...
  return (
    <div className="relative ">
      <div className="">
        <h1 className="text-black text-[38px]  font-bold text-center md:text-start">
          Rent a place with ease
        </h1>
